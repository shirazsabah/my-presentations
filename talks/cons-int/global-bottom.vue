...
<template>
  ...
  >
    <div
      class="clip bg-gradient-to-r from-[#0054dc] to-white/10"
      :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-l from-[#f2f6f7] to-white/10"
  ...
  <footer
    ...
    class="absolute bottom-0 right-0 p-2 z-50"
  >
    <img src="/rnoh_logo.png" alt="Logo" class="logo" />
  </footer>
